...
// import { AdminModel } from '../../unboxd-entities';
// import { getAdminService } from '../../unboxd-accounts/admin/services';
// import { 
//   ChangeAdminPasswordDTO, VerifyUserPasswordDTO, VerifyAdminEmailDTO, ResetPasswordDTO } from '../DTOs/passwordManager.DTO';


// export const VerifyAdminPasswordPipe = async ({ oldPassword, email }: VerifyUserPasswordDTO) => {
...
// export const VerifyAdminEmailPipe = async ({ adminID, email }: VerifyAdminEmailDTO) => {
//   const admin = await getAdminService({adminID}, {shouldPopulate: false});
...
// export const ChangeAdminPasswordPipe = async ({adminID, newPassword, confirmPassword,}: ChangeAdminPasswordDTO) => {
//   const {_id} = await getAdminService({adminID}, {shouldPopulate: false});
...
// export const ResetAdminPasswordPipe = async (
